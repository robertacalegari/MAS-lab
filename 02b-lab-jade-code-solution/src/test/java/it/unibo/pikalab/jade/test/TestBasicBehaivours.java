...
import it.unibo.pikalab.jade.test.agents.*;
...
public class TestBasicBehaivours {
    ...
    public void testLogging() throws InterruptedException {
        var agent = JadeTestingUtils.spawnTestAgent("testLoggingAgent", TestLoggingAgent.class);
    ...
    public void testSequential() throws InterruptedException {
        var agent = JadeTestingUtils.spawnTestAgent("testSequentialAgent", TestSequentialAgent.class);
        agent.awaitTermination();
    ...
    public void testParallelAnd() throws InterruptedException {
        var agent = JadeTestingUtils.spawnTestAgent("testParallelAndAgent", TestParallelAndAgent.class);
        agent.awaitTermination();
    ...
    public void testParallelOr() throws InterruptedException {
        var agent = JadeTestingUtils.spawnTestAgent("testParallelOrAgent", TestParallelOrAgent.class);
        agent.awaitTermination();
    ...
    public void testDoWhile() throws InterruptedException {
        var agent = JadeTestingUtils.spawnTestAgent("testDoWhileAgent", TestDoWhileAgent.class);
        agent.awaitTermination();
    ...
    public void testSendReceive() throws InterruptedException {
        var receiver = JadeTestingUtils.spawnTestAgent(TestReceiverAgent.PREFERRED_NAME, TestReceiverAgent.class);
        var sender = JadeTestingUtils.spawnTestAgent(TestSenderAgent.PREFERRED_NAME, TestSenderAgent.class);
    ...
    public void testMultipleSendReceive() throws InterruptedException {
        var receiver = JadeTestingUtils.spawnTestAgent(TestMultipleReceiverAgent.PREFERRED_NAME, TestMultipleReceiverAgent.class);
        var sender = JadeTestingUtils.spawnTestAgent(TestMultipleSenderAgent.PREFERRED_NAME, TestMultipleSenderAgent.class);
